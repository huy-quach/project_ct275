        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">PhoneHA&reg;</h2>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            Copyright © 2023 PhoneHA&reg;
                            | Designed by <a rel="sponsored" href="#" target="_blank">Quyen Anh - Huyen Huy</a>
                        </p>
